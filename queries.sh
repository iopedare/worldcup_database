...
echo "$($PSQL "SELECT DISTINCT(t.name) FROM teams AS t FULL JOIN games AS w ON t.team_id = w.winner_id FULL JOIN games AS o ON t.team_id = o.opponent_id WHERE (w.year=2014 OR o.year=2014) AND (w.round='Eighth-Final' OR o.round='Eighth-Final')")"
